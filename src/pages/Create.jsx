    ...
    <div className="bg-gray-100 min-h-screen flex flex-col">
      <div className="max-w-7xl mx-auto bg-white shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div>
            <img src="/Images/create.jpg" alt="Create Account" className="w-full h-full object-cover" />
          </div>
          <div className="p-10">
            <h2 className="text-2xl font-bold">Create New Account</h2>
            <p className="text-gray-500 mb-4">Please enter details</p>
            <form>
              <label className="block mb-2">First Name</label>
              <input type="text" className="w-full border rounded p-2 mb-4" placeholder="Robert" />

              <label className="block mb-2">Last Name</label>
              <input type="text" className="w-full border rounded p-2 mb-4" placeholder="Fox" />
